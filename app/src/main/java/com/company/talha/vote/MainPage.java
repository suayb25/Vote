       ...
       menuL3.child(mAuth.getCurrentUser().getUid()).addValueEventListener(new ValueEventListener() {
           ...
           public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
               ...
               if(freeze && !free.equals("Açmak istiyorum") ){
                   if(free.equals("Stable")){
                       Toast.makeText(MainPage.this,"Your Profile Freezed",Toast.LENGTH_SHORT).show();
                   }if(!free.equals("Stable")){
                       ...
                       builder1.setNegativeButton("ReFreeze", new DialogInterface.OnClickListener() {
                           ...
                           public void onClick(DialogInterface dialog, int which) {
                               ...
                               Toast.makeText(MainPage.this,"Your Profile Refreezed response is received to us!",Toast.LENGTH_SHORT).show();
                           }
                       });
                       builder1.show();
                   }
               ...
               if(freeze && free.equals("Açmak istiyorum") && h){
