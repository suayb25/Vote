                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        for (DataSnapshot ds : dataSnapshot.getChildren()) {
                            ...
                            for (DataSnapshot ds1 : ds.getChildren()) {
                                ...
                                if((name.equals(electionname1.getText().toString()) || name.toUpperCase().equals(electionname1.getText().toString().toUpperCase()) )&&( question.equals(electionquestion.getText().toString())|| question.toUpperCase().equals(electionquestion.getText().toString().toUpperCase()))){
                                    k=false;
                                }
                            }
                        }
