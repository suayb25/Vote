...
public class ApplyElections extends AppCompatActivity {
    ...
    private DatabaseReference apply2 = FirebaseDatabase.getInstance().getReference("Elections");
      ...
      /*  String[] days = new String[]{
        ...
        dynamic.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                ArrayAdapter<String> spinnerArrayAdaptor = new ArrayAdapter<String>(ApplyElections.this,R.layout.spinner_item,plants1);
...
// dialog penceresinin button bilgilerini ayarlıyoruz ve ekranda gösteriyoruz.
       ...
       /* ArrayAdapter<String> spinnerArrayAdaptor1 = new ArrayAdapter<String>(this,R.layout.spinner_item,days);
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                k=true;
                apply2.addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        for (DataSnapshot ds : dataSnapshot.getChildren()) {
                            ...
                            for (DataSnapshot ds1 : ds.getChildren()) {
                                ...
                                question = ds1.child("Question").getValue(String.class);
                                if((name.equals(ElectionName.getText().toString()) || name.toUpperCase().equals(ElectionName.getText().toString().toUpperCase()) )&&( question.equals(Question.getText().toString())|| question.toUpperCase().equals(Question.getText().toString().toUpperCase()))){
                                    k=false;
                                }
                            }
                        }
                                ...
                                if(day1>daynow){
                                    if(ElectionName.getText().length()<=0 || Question.getText().length()<=0 ||Option1.getText().length()<=0 ||Option2.getText().length()<=0 ||Option3.getText().length()<=0){
                                        ...
                                        if(k){
                                            ...
                                            Toast.makeText(getApplicationContext(), "This Election is already created!", Toast.LENGTH_SHORT).show();
                                        }
