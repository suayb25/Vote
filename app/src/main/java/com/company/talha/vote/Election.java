...
public class Election extends AppCompatActivity {//Election View
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myRef.child(choosen).child(id).addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(!dataSnapshot.exists()){
                    AlertDialog.Builder builder1=new AlertDialog.Builder(Election.this);
                    builder1.setTitle("This Election Deleted");
                    builder1.setMessage("Please refresh your page!");
                    builder1.setCancelable(false);
                    builder1.setPositiveButton("Okey", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialogInterface, int i) {
                            Intent authIntent=new Intent(Election.this,MainPage.class);
